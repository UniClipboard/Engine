...
const SPAN_RULES = [
  ...
  'IsMatch(span.attributes["uc.operation"], "^(clipboard[.](copy_and_sync|persist|write_system)|clipboard_dispatch|clipboard_receive|clipboard_address_resolve|clipboard_connect|space_admission|membership_history_sync|membership_group_update|network_transport|profile_storage_upgrade|session_lifecycle)$") == false',
...
const LOG_RULES = [
  ...
  'IsMatch(log.attributes["uc.operation"], "^(clipboard[.](copy_and_sync|persist|write_system)|clipboard_dispatch|clipboard_receive|clipboard_address_resolve|clipboard_connect|space_admission|membership_history_sync|membership_group_update|network_transport|profile_storage_upgrade|session_lifecycle)$") == false',
...
const CONSISTENCY_RULES = [
  ...
  '(IsMatch(span.attributes["uc.operation"], "^clipboard[.](copy_and_sync|persist|write_system)$") and (span.attributes["uc.role"] != "local" or span.kind != SPAN_KIND_INTERNAL))',
  ...
  '(IsMatch(log.attributes["uc.operation"], "^clipboard[.](copy_and_sync|persist|write_system)$") and log.attributes["uc.role"] != "local")',

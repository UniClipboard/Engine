...
- **状态**：设计中
- **日期**：2026-08-30
- **前置规格**：`docs/specs/029-durable-membership-history-anti-entropy.md`
- **相关决策**：`docs/adr/020-membership-reconciliation-and-user-decisions.md`、`docs/adr/021-workspace-convergence-internal-boundaries.md`

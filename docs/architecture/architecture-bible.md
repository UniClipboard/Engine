...
- 2026-09-13：新增[配对到期、本机终止与新意图替换规格](../exec-plans/active/2026-09-13-admission-expiry-and-replacement.md)，区分协议决定、正式应用和最终结算，记录双端自主到期、精确成员撤销、未知远端提交与跨空间清理的待实现方案；仅研究与计划，未改变现有运行架构，实施前决策见规格末节。

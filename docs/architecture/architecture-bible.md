...
| 日期 | 主题 | 长期结论 |
| --- | --- | --- |
| 2026-09-06 | Engine rc.6 发布准备 | 同步 Engine workspace、HarmonyOS 包与宿主版本检查到 1.1.0-rc.6，业务最低版本与独立 LAN 兼容线不变。按现有不可变三端资产发布流程验证，未执行设备矩阵保持 skipped；构建与公开发布结果另记发布工作记录，不预先宣称发布成功。 |

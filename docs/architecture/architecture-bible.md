...
- 2026-09-17：新增[已知设备联系驱动的成员恢复与地址更新计划](../exec-plans/active/2026-09-17-known-peer-contact-recovery.md)，并完成第一切片。经过传输身份验证、能映射到当前成员但尚未准入的入站联系会唤醒该目标的成员确认，不等待持久退避到期；联系仍不代表成员资格、准入、在线或可持久地址。成员维护继续负责合并、串行与周期兜底；公开接口、设备间协议和持久格式未改变。

...
pub use space_admission::{
    ...
    AdmissionAttemptContractError, AdmissionAttemptContractV2, AdmissionBaseSnapshot,
    AdmissionCandidateError, AdmissionCandidateV1, AdmissionChannelPeerId, AdmissionCommitV1,

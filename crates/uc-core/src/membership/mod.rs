...
pub use admission_attempt::{
    ...
    AdmissionIdentityBindingError, AdmissionIdentityBindingV1, AdmissionInboxRecordV1,
    ...
    TerminalAdmissionAttemptV1, ADMISSION_ATTEMPT_FORMAT_V1, ADMISSION_IDENTITY_BINDING_FORMAT_V1,

...
use crate::{
    ...
    RevalidateMobileCredentialInput, SetRelayCredentialInput, SettingsPatch,
    StageConfigImportInput, UpdateDebugModeInput, UpdateMobileDeviceInput,
};
...
impl fmt::Display for OperationKind {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        let value = match self {
            ...
            Self::SetRelayCredential => "set_relay_credential",
            Self::DeleteRelayCredential => "delete_relay_credential",
...
pub enum Operation {
    ...
    SetRelayCredential(SetRelayCredentialInput),
    DeleteRelayCredential(RelayCredentialInput),
    QueryUpgradeStatus,
    AcknowledgeUpgrade,
    QueryDiagnostics,
...
impl Operation {
    pub fn kind(&self) -> OperationKind {
        match self {
            ...
            Self::SetRelayCredential(_) => OperationKind::SetRelayCredential,
            Self::DeleteRelayCredential(_) => OperationKind::DeleteRelayCredential,

...
impl WorkspaceMembership {
    ...
    pub(in crate::space) async fn save_member_facts(
        &self,
...
#[async_trait]
impl SpaceMembershipInitializerPort for WorkspaceMembership {
...
) -> MembershipInitializationError {
    match error {
        WorkspaceConvergenceError::Inconsistent(_) => MembershipInitializationError::Inconsistent,
        _ => MembershipInitializationError::Unavailable,
    }
}

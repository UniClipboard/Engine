...
use crate::space::maintain_space_membership::RecoverMembershipEffectsPort;
...
use crate::space::query_device_trust::QueryDeviceTrustUseCase;
            ...
            .compare_and_commit_history(
                ...
                move |record, history, verifier| {
                    ...
                    record
                        ...
                        .or_insert(crate::space::membership_ledger::PeerReconciliationRecord {

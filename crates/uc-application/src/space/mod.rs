...
pub use membership::{KnownPeerIdentity, PeerAccess, PeerIdentityDirectoryPort};
...
pub use membership::{
    ...
    RestrictedMembershipDeliveryPort, SpaceMemberPauseReason, StagedMembershipRecord,
};
pub use membership::{

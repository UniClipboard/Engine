...
#[async_trait]
impl crate::space::rebuild_space::SpaceMembershipResetPort for MembershipLedger {
    async fn reset(&self) -> Result<(), crate::space::rebuild_space::SpaceMembershipRebuildError> {
        self.reset_for_space_rebuild()
            .await
            .map_err(|error| match error {
                MembershipLedgerError::Corrupt | MembershipLedgerError::RecoveryRequired => {
                    crate::space::rebuild_space::SpaceMembershipRebuildError::Inconsistent
                }
                MembershipLedgerError::Locked
                | MembershipLedgerError::Conflict
                | MembershipLedgerError::Unavailable => {
                    crate::space::rebuild_space::SpaceMembershipRebuildError::Unavailable
                }
            })
    }
}

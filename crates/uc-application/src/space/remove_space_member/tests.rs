...
use super::*;
use crate::space::current_member_signing::{
...
use crate::space::query_device_trust::{
...
#[async_trait]
impl crate::space::maintain_space_membership::RecoverMembershipEffectsPort for NoopEffects {
    async fn recover_membership_effects(
        &self,
    ) -> crate::space::maintain_space_membership::MembershipMaintenanceStepOutcome {
        crate::space::maintain_space_membership::MembershipMaintenanceStepOutcome::Completed
    }
}
...
#[async_trait]
impl crate::space::maintain_space_membership::RecoverMembershipEffectsPort for EffectCounter {
    async fn recover_membership_effects(
        &self,
    ) -> crate::space::maintain_space_membership::MembershipMaintenanceStepOutcome {
        self.0.fetch_add(1, Ordering::SeqCst);
        crate::space::maintain_space_membership::MembershipMaintenanceStepOutcome::Deferred
    }
}
...
async fn removal_commits_all_local_facts_once_before_returning_success() {
    ...
    assert_eq!(
        ...
        DeviceTrustSyncState::Paused(
            crate::space::membership_ledger::SpaceMemberPauseReason::PendingLocalDecision
        )
    );

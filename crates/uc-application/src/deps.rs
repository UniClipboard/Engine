...
pub use crate::space::{
    ...
    PreparedJoinerCandidateMaterial, PreparedSponsorCandidate, RePairingStateError,
    RePairingStateStorePort, RebindSpaceSessionPort, RecoverMembershipEffectsPort,
    RecoverSpaceAdmissionsPort, RestrictedMembershipDelivery, RestrictedMembershipDeliveryError,
    ...
    SpaceSessionActivityDeps, SpaceSessionActivityPort, SponsorAdmissionMutation,
    SponsorAdmissionSecurityDelivery, SponsorAdmissionSecurityRecipient,
    SponsorAdmissionSecurityRequest, SponsorJoinRequestCommitToken, SponsorJoinRequestState,
    SponsorJoinRequestStateError, SponsorJoinRequestStatePort, SponsorPreparedAdmissionSecurity,

...
pub use crate::space::{
    ...
    InitializeSpacePort, IsSpaceUnlockedPort, JoinerStagedSecurityTransition,
    LoadCurrentJoinStatusPort, LoadDeviceTrustObservationsPort, LoadMembershipLedgerPort,
    LoadedMembershipLedger, LockSpacePort, MembershipEffectExecutionError, MembershipEffectKind,
    MembershipEffectPhase, MembershipLedgerError, MembershipLedgerMutation,
    MembershipMaintenanceStepOutcome, MembershipNetworkActivityPort, MembershipSessionActivityPort,
    PausedSpaceMember, PeerHistorySyncState, PeerReconciliationRecord, PendingMembershipEffect,
    PortableCurrentSpaceIdentityPort, PrepareMembershipBranchTransitionError,
    PrepareMembershipBranchTransitionInput, PrepareMembershipBranchTransitionPort,
    PrepareSpaceAdmissionCredentialsPort, QueryDeviceTrustError,

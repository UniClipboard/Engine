...
pub use crate::space::{
    ...
    RecoverMembershipEffectsPort, RecoverSpaceAdmissionsPort, RestrictedMembershipDelivery,
    RestrictedMembershipDeliveryError, RestrictedMembershipDeliveryPort, ResumeSpaceSessionPort,
    SpaceActivityError, SpaceAdmissionCommitToken, SpaceAdmissionMessageReply,
    SpaceAdmissionTransportError, SpaceAdmissionTransportPort, SpaceApplicationDeps,
    SpaceMemberPauseReason, SpaceSessionActivityDeps, SpaceSessionActivityPort,
    SponsorAdmissionCommitToken, SponsorAdmissionMutation, SponsorAdmissionSecurityDelivery,
    SponsorAdmissionSecurityRecipient, SponsorAdmissionSecurityRequest, SponsorAdmissionState,
    SponsorAdmissionStateError, SponsorAdmissionStatePort, SponsorPreparedAdmissionSecurity,

...
pub use crate::space::{
    ...
    HandleSpaceAdmissionMessagePort, JoinerStartMaterial, JoinerStartMaterialError,
    JoinerStartMaterialPort, JoinerStartMutation, JoinerStartStateError, JoinerStartStatePort,
    LoadedJoinerStartState, PrepareSpaceAdmissionMessagePort, PrepareSponsorAdmissionSecurityPort,
    PreparedSpaceAdmissionCommit, PreparedSpaceAdmissionMessage, RePairingStateError,
    ...
    SpaceAdmissionCommitToken, SpaceAdmissionPreparationContext, SpaceApplicationDeps,

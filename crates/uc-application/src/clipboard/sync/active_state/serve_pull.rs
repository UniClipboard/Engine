...
use crate::clipboard::sync::snapshot_from_entry::{BuildSnapshotError, SnapshotReconstructor};
...
mod tests {
    ...
    use crate::clipboard::sync::payload_codec::decode_v3_bytes_to_snapshot_and_blob_refs;
    use crate::facade::{
    ...
    async fn serves_envelope_for_held_content() {
        ...
        let snapshot = crate::clipboard::sync::payload_codec::decode_v3_bytes_to_snapshot(&seen)
    ...
    async fn serves_directory_entry_with_file_set_manifest() {
        ...
        let (snapshot, blob_refs, manifest) =
            crate::clipboard::sync::payload_codec::decode_v3_bytes_to_snapshot_blob_refs_and_file_set(&seen)
        ...
        let err = crate::clipboard::sync::payload_codec::decode_v3_bytes_as_legacy_peer(&seen)
    ...
    async fn flat_manifest_entry_serves_without_file_set_trailer() {
        ...
        let (snapshot, blob_refs) =
            crate::clipboard::sync::payload_codec::decode_v3_bytes_as_legacy_peer(&seen)

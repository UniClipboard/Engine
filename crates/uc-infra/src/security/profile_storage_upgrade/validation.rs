...
use super::target::{RuntimeTableSet, TargetGenerationStager};
...
impl RuntimeGenerationValidator {
    ...
    pub(super) fn validate(
        ...
        target.verify_runtime_row_ownership(journal, RuntimeTableSet::Staged)?;
    ...
    pub(super) fn verify_promoted(
        ...
        validate_database(&profile)?;
        validate_database(&paths.control_database)?;
        target.verify_runtime_row_ownership(journal, RuntimeTableSet::Promoted)?;
